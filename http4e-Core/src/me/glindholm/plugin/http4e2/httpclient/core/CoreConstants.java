...
public interface CoreConstants {
    ...
    String[] HTTP11_METHODS = { HTTP_GET, HTTP_POST, HTTP_PUT, HTTP_DELETE, HTTP_HEAD, HTTP_OPTIONS, HTTP_TRACE };
...
//   String   SERIALIZED_PATH   = System.getProperty("java.io.tmpdir") + File.separator + "http4e-" + CoreMessages.VERSION + ".ser";
    ...
    String PLUGIN_CORE = "me.glindholm.plugin.http4e2.core";
    String PLUGIN_UI = "me.glindholm.plugin.http4e2.ui";
