...
public class Snippet163old {
    ...
    public static void main(final String[] args) {
        ...
        final Font font1 = new Font(display, data.getName(), data.getHeight() * 2, data.getStyle());
        final Font font2 = new Font(display, data.getName(), data.getHeight() * 4 / 5, data.getStyle());
        final StyleRange[] styles = new StyleRange[8];
        ...
        final int[] ranges = { 16, 4, 61, 13, 107, 10, 122, 10, 134, 3, 143, 6, 160, 7, 168, 7 };
