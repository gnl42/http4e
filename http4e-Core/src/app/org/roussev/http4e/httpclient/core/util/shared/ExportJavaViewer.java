...
/*******************************************************************************
 * Copyright (c) 2000, 2003 IBM Corporation and others. All rights reserved. This program and the
...
class JavaLineStyler implements LineStyleListener {
    ...
    boolean inBlockComment(final int start, final int end) {
        for (int i = 0; i < blockComments.size(); i++) {
            final int[] offsets = (int[]) blockComments.elementAt(i);
    ...
    public class JavaScanner {
        ...
        private final String[] fgKeywords = { "assert", "enum", "abstract", "boolean", "break", "byte", "case", "catch", "char", "class", "continue", "default",
                "do", "double", "else", "extends", "false", "final", "finally", "float", "for", "if", "implements", "import", "instanceof", "int", "interface",
                "long", "native", "new", "null", "package", "private", "protected", "public", "return", "short", "static", "super", "switch", "synchronized",
                "this", "throw", "throws", "transient", "true", "try", "void", "volatile", "while", "var", "script", "function", "src", "type", "language",
                "foreach", "using", "mx", "rest", "Imports", "Public", "Private", "Class", "Interface", "Shared", "End", "Sub", "Dim", "If", "Then", "Using",
                "Try", "Catch", "IsNot", "AndAlso", "Not", "Implements", "begin", "end", "puts", "require", "require_once", "echo", "php", "def", "print" };
