...
public class HttpClientSSLTest {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        final Protocol myhttps = new Protocol("https", new StrictSSLProtocolSocketFactory()/* new EasySSLProtocolSocketFactory() */, 443);
        httpclient = new HttpClient();
    ...
    public static void testSSL() throws Exception {
        ...
        final Socket socket = SSLSocketFactory.getDefault().createSocket(TARGET_HTTPS_SERVER, TARGET_HTTPS_PORT);
        try (socket) {
            final Writer out = new OutputStreamWriter(socket.getOutputStream(), "ISO-8859-1");
            out.write("GET / HTTP/1.1\r\n");
            out.write("Host: " + TARGET_HTTPS_SERVER + ":" + TARGET_HTTPS_PORT + "\r\n");
            out.write("Agent: SSL-TEST\r\n");
            out.write("\r\n");
            out.flush();
            final BufferedReader in = new BufferedReader(new InputStreamReader(socket.getInputStream(), "ISO-8859-1"));
            String line = null;
