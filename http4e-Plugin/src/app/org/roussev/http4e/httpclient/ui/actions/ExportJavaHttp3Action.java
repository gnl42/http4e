...
public class ExportJavaHttp3Action extends Action {
    ...
    public ExportJavaHttp3Action(final ViewPart view) {
        this.view = view;
        fMenu = null;
    ...
    public void run() {
        try {
            ...
            final ExportDialog dialog = new ExportDialog(view, "Apache HTTP Client 3.x call", "Your call exported as Java Apache HTTP Client 3.x call.",
                    writer.toString());
            dialog.open();
